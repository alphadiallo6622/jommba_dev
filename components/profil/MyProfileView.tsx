  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-4 pb-24 relative">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold text-[#064E3B]">Mon profil</h1>
        <button
      ...
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-gray-900 mb-1">
          {mockUser.firstName}, {mockUser.age} ans · {mockUser.height} cm
        </h2>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        >
          <Camera className="w-4 h-4" /> Modifier mes images
        </button>
        <button
          onClick={openBoost}
        ...
        >
          <Zap className="w-4 h-4" /> Booster mon profil ›
        </button>
      </div>
      ...
      <div className="space-y-3">
        ...
        <ProfileGridSection
          ...
          fields={[
            { label: 'MADHHAB', value: mockUser.religion.madhhab },
            { label: 'MOSQUÉE', value: mockUser.religion.mosque  },
            { label: 'ARABE',   value: mockUser.religion.arabic  },
          ]}
        />
        <ProfileGridSection
          ...
          title="Projet de vie"
          fields={[
            { label: 'A DES ENFANTS',        value: mockUser.lifeProject.hasChildren   },
            { label: 'SOUHAITE DES ENFANTS', value: mockUser.lifeProject.wantsChildren },
            { label: 'DÉMÉNAGER',            value: mockUser.lifeProject.canRelocate   },
            { label: 'POLYGAMIE',            value: mockUser.lifeProject.polygamy      },
          ]}
        />
        <ProfileSection
