...
const OPTIONS = [
  { value: 'celibataire', label: 'Célibataire',   emoji: '💍', desc: 'Jamais marié(e)' },
  { value: 'divorce',     label: 'Divorcé(e)',     emoji: '📄', desc: 'Séparé(e) légalement' },
  { value: 'veuf',        label: 'Veuf / Veuve',   emoji: '🤲', desc: 'Après le décès du conjoint' },
  { value: 'marie',       label: 'Marié(e)',        emoji: '👪', desc: 'En recherche de seconde union' },
]
  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-serif font-bold text-gray-900">Situation maritale</h2>
        <p className="text-sm text-gray-500">Ta situation actuelle.</p>
      </div>
